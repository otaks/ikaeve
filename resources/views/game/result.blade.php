                ...
                <form method="POST" name="resultFrm" action="{{ route('game.result') }}">
                    ...
                    <div class="form-group offset-md-4 row mt-4">
                      <div class="col-md-3 col-4 ml-3">
                        <select name="score[]" id="score" class="form-control col-md-10" @if ($mode == 'app') disabled @endif>
                      ...
                      <div class="col-md-3 col-4 ml-3">
                        <select name="score[]" class="form-control col-md-10" @if ($mode == 'app') disabled @endif>
                          @for($cnt = 0; $cnt <= $event->pre_score; $cnt++)
                    ...
                    <div class="form-group row offset-md-4">
                      <div class="col-md-3 col-5 text-center">
                        ...
                        @else
                          <button type="button" name="unearned[]" class="btn btn-outline-success" @if ($mode == 'app') disabled @endif>不戦勝</button>
                        @endif
                      </div>
                    ...
                    <div class="form-group row offset-md-4">
                        <div class="col-md-7 text-center">
                            ...
                            @else
                              <button type="button" id="submitBtn" class="btn btn-primary submit" @if(!$data) disabled @endif>更新</button>
