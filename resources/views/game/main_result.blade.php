...
@section('content')
        <div class="card-body">
            <div class="container-fluid">
                <form method="POST" name="resultFrm" action="{{ route('game.main_result') }}">
                    @csrf
                    ...
                    <div class="form-group row offset-md-4 mt-5">
                        <div class="col-md-3 col-5 text-center">
                          <select name="turn" class="form-control col-md-10">
                            <option value="1">1戦目</option>
                            <option value="2">2戦目</option>
                            <option value="3">3戦目</option>
                            <option value="4">4戦目</option>
                            <option value="5">5戦目</option>
                          </select>
                        </div>
                    </div>
